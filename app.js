...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "public/fonts/koz-l.otf";
...
/***/ (function(module, exports) {
									...
									A2(
										...
										A2(
											...
											A2(
												_elm_lang$core$Basics_ops['++'],
												'),',
												A2(segment, n + 1, m)))))))) : (_elm_lang$core$Native_Utils.eq(n, m) ? A2(
						_elm_lang$core$Basics_ops['++'],
						'rgb(',
						A2(
							_elm_lang$core$Basics_ops['++'],
	...
	var _user$project$Top_View$waveform = {
		ctor: '::',
		_0: {
			ctor: '::',
			_0: 0.748,
		...
		switch (_p0.ctor) {
			case 'Top':
				return A2(
					...
					_user$project$Types$TopMsg,
					_user$project$Top_View$root(model.top));
			case 'Works':
				return A2(
					_elm_lang$html$Html$map,
